  ...
  return (
    <div className="space-y-3 rounded-2xl border border-orange-100 bg-white p-5 shadow-soft">
      ...
      <p className="text-zinc-700">
        মুই লালমনিরহাটের মানুষ। রোজার বেলা কোন মসজিদে ইফতার আর বিরানি আছে, এইট্যাঁ মানুষে মানুষে দ্রুত জানবার জন্নে এই
        সাইটডা বানাইছং।
      </p>
      <p className="text-zinc-700">
       মোর ইচ্ছা একটাই, এলাকার সগায় যেন বিরানির ঠিক খবর পাই। তাই এইহানে যেই ভোট দাও, খাটি খবর দিও, গুজব
        দিয়ো না।
      </p>
